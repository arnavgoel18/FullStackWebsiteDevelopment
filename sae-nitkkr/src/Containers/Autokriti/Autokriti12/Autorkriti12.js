        ...
        <div className="register_line-container">
          ...
          <h4>
            ...
            <p className="register_line-last">
              Interested in automobiles, but don’t know where to start? Let’s
              this be your first step, to the world of electrification. Join
              Autokriti 12 and be the part of this remaking
            </p>
          </h4>
          <Link to="/autokriti/register">
            <center>
