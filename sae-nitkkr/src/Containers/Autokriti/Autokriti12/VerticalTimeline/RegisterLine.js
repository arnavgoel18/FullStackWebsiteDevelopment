    ...
    return(
        <>
            <div className="register_line-container">
                    ...
                    <p>1. There are 4 Departments - <br/><br/><ul style={{marginLeft: "2em"}}><li>Mechanical</li><li>EV</li><li>IOT</li><li>Softwares</li></ul><br/>You can choose Max 2 Departments</p>
                    <p>2. Each Department/Workshop is 3 Days long</p>
                    <p>3. If you choose 1 workshop, your totoal duration will be 4 Days. 3 Days Workshop + 1 Day Guest Lecture</p>
                    <p>4. If you choose 2 workshops, your total duration will be 7 Days. 3 Days Workshop (Department 1) + 1 Day Guest Lecture + 3 Days Workshop (Department 2)</p>
                   ...
                   <Link to="/autokriti/register">
                    <center><button className="register_line-btn">Register Here</button></center>
                </Link>
            </div>
        </>
    )
