...
function Acc() {
  return (
    <div>
       <div className="TeamAboutUs-heading"><h2 className="TeamAboutUs-weare"> we </h2><h2 className="TeamAboutUs-weare"> are</h2><h2 className="TeamAboutUs-boldcolor">ACCELERONS</h2></div>
...
From being a first-timer in SUPRA 2014 to standing on top among all NITS in SUPRA 2018, the Team has come a long way, upgrading itself with each passing season.. After all Felipe Massa rightly said, "When you give up your hunger for success you are not racing full heartedly anymore.</div></div>
    <div className="TeamAboutUs-bigcontainer">
      ...
      <div className="TeamAboutUs-image_container"><div className="TeamAboutUs-image"><img src={accimg} alt="image" /></div></div>
    </div>
    </div>
  )
}
