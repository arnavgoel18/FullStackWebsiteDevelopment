...
function FundingTimeline({ amount }) {
  ...
  const Next = ({ onClick }) => {
    return (
      <div className='arrow next' style={{ right: '1%' }} onClick={onClick}>
        <svg
          style={{
            cursor: 'pointer',
            width: '15px',
        ...
        >
          <path
            d='M1.42495 10.4125L5.82495 6.00002L1.42495 1.58752'
            stroke='black'
            stroke-width='1.5'
  ...
  const Back = ({ onClick }) => {
    return (
      <div className='arrow prev' style={{ left: '1%' }} onClick={onClick}>
        <svg
        ...
        >
          <path
            d='M5.57505 10.4125L1.17505 6.00002L5.57505 1.58752'
            stroke='black'
            stroke-width='1.5'
            stroke-linecap='round'
            stroke-linejoin='round'
