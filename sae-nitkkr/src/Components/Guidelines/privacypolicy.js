...
import './privacypolicy.css';
 function PrivacyPolicy(){
    return(
        ...
        <h1>Privacy Policy for SAE NIT Kurukshetra</h1>
<br/>
<p>At SAE NIT Kurukshetra, accessible from https://saenitkurukshetra.in, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by SAE NIT Kurukshetra and how we use it.</p>
