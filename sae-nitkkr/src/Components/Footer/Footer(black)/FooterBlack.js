  ...
  return (
    <div id="black_footer">
      <div id="black_footer_box1">
        ...
        <div id="black_explore_us_content" className="black_each_footer_content">
      ...
      <div id="black_footer_box2">
        ...
        <div id="black_social_content" className="black_each_footer_content">
          <p>
            ...
            /></a>
           <a href="https://www.facebook.com/teamaccelerons/" target="_blank"> <img
      ...
      <div id="black_footer_box3">
        ...
        <div id="black_contact_us_content" className="black_each_footer_content">
          <p>
            {" "}
            <img
              ...
              alt="contact_image"
            />
            <span id="black_email_text"> <a href="mailto:saenitkurukshetra@gmail.com">saenitkurukshetra@gmail.com</a></span>
          </p>
          ...
          <p>
            ...
            <img
              ...
              alt="contact_image"
            />
            <span id="black_linkedin_text"><a href="https://in.linkedin.com/company/sae-nit-kkr" target="_blank">linked.com/company/sae-nit-kkr</a></span>
          </p>
        </div>
      </div>
      <div id="black_footer_box4">
        ...
        <div id="black_newsletter_content" className="black_each_footer_content">
          <br />
          <input
          ...
          <br />
          <br />
          <input type="checkbox" id="black_select" name="select" value="got_it" />
